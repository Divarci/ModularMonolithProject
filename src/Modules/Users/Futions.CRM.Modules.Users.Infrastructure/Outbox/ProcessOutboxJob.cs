    ...
    ILogger<ProcessOutboxJob> logger) : IJob
{
    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        IReadOnlyList<MessageResponse> outboxMessages = await ActionsFactory<UsersOutboxMessage>
        ...
        foreach (MessageResponse outboxMessage in outboxMessages)
        {
            ...
            await ActionsFactory<UsersOutboxMessage>.Update<IUsersUnitOfWork>(_serviceScopeFactory, outboxMessage, exception);
